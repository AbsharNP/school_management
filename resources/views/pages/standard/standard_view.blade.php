                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700/50">
                            <tr>
                                ...
                                <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Group</th>
                                ...
                                <tr id="emptyRow">
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400 font-medium">No classes found</p>
                                            <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Click "Add Class" to create your first Class</p>
                                        </div>
                                    </td>
                                </tr>
                            @endif
        ...
        <div id="formModal" class="hidden fixed inset-0 z-[99999] flex items-center justify-center p-4">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md transform transition-all duration-300 scale-95 opacity-0" id="modalContent">
                <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                    <h3 id="modalTitle" class="text-lg font-semibold text-gray-800 dark:text-white">Add Class</h3>
                ...
                <form id="crudForm">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                                ...
                                <select id="class_group_id" name="classgroup_id" 
                                ...
                                <p id="classgroup_idError" class="mt-1 text-xs text-red-500 hidden"></p>
                            </div>
                    </div>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            function openModal(title = 'Add Class') {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.success) {
                            ...
                            $('#class_group_id').val(res.data.classgroup_id);
            ...
            $('#crudForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    data: {
                        _token: CSRF_TOKEN,
                        name: $('#name').val(),
                        classgroup_id: $('#class_group_id').val(),
                    },
                    success: function (res) {
                        if (res.success) {
                                        ...
                                        $('#tableBody').html(`
                                            <tr id="emptyRow">
                                                <td colspan="4" class="px-6 py-12 text-center">
                                                    <div class="flex flex-col items-center">
                                                        <i class="fas fa-layer-group text-4xl text-gray-300 dark:text-gray-600 mb-3"></i>
                                                        <p class="text-gray-500 dark:text-gray-400 font-medium">No class  found</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        `);
