        ...
        <div class="col-span-12">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Permissions</h2>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <button type="button"
                                                ...
                                                title="Edit permission" data-id="{{ $row->id }}">
                                            ...
                                            <button type="button"
                                                ...
                                                title="Delete permission" data-id="{{ $row->id }}">
                                ...
                                <tr id="emptyRow">
                                    <td colspan="3" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400 font-medium">No permissions found</p>
                                            <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Click "Add Permission" to create your first permission</p>
                                        </div>
                                    </td>
                                </tr>
                            @endif
        ...
        <div id="formModal" class="hidden fixed inset-0 z-[99999] flex items-center justify-center p-4">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md transform transition-all duration-300 scale-95 opacity-0" id="modalContent">
                <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                    <h3 id="modalTitle" class="text-lg font-semibold text-gray-800 dark:text-white">Add Permission</h3>
    ...
    <script>
        $(document).ready(function () {
            ...
            function showToast(message, type = 'success') {
                ...
                toast.removeClass('hidden bg-green-600 bg-red-600 bg-green-500 bg-red-500 translate-x-full opacity-0');
            ...
            function openModal(title = 'Add Permission') {
            ...
            $('#crudForm').on('submit', function (e) {
                ...
                const isEdit = id !== '';
                const url = isEdit ? '/permissions/' + id : '/permissions';
