        ...
        <div class="col-span-12">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Teachers</h2>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage teacher records and information</p>
                    </div>
                    {{-- <button id="btnCreate"
                        ...
                        <tbody id="tableBody" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($teachers as $index => $row)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors" data-id="{{ $row->id }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $row->subject ?? '—' }}</td>
                                ...
                                <tr id="emptyRow">
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            <i class="fas fa-chalkboard-teacher text-4xl text-gray-300 dark:text-gray-600 mb-3"></i>
                                            <p class="text-gray-500 dark:text-gray-400 font-medium">No teachers found</p>
                                            <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Click "Add Teacher" to register your first teacher</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
        ...
        <div id="formModal" class="hidden fixed inset-0 z-[99999] flex items-center justify-center p-4">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg transform transition-all duration-300 scale-95 opacity-0 max-h-[90vh] overflow-y-auto" id="modalContent">
                <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800 rounded-t-2xl">
                    <h3 id="modalTitle" class="text-lg font-semibold text-gray-800 dark:text-white">Add Teacher</h3>
