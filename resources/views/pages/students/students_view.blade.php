                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700/50">
                            <tr>
                                ...
                                <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Roll No.</th>
                                ...
                                <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Guardian</th>
                        ...
                        <tbody id="tableBody" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($students as $index => $row)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors" data-id="{{ $row->id }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $row->roll_number ?? '—' }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $row->guardian_name ?? '—' }}</td>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg transform transition-all duration-300 scale-95 opacity-0 max-h-[90vh] overflow-y-auto" id="modalContent">
                ...
                <form id="crudForm">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label for="roll_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                    Roll Number
                                </label>
                                <input type="text" id="roll_number" name="roll_number"
                                    class="w-full h-11 rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent px-4 text-sm text-gray-800 dark:text-white placeholder:text-gray-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:bg-gray-900 transition-colors"
                                    placeholder="e.g. 001">
                                <p id="roll_numberError" class="mt-1 text-xs text-red-500 hidden"></p>
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label for="guardian_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                    Guardian Name
                                </label>
                                <input type="text" id="guardian_name" name="guardian_name"
                                    class="w-full h-11 rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent px-4 text-sm text-gray-800 dark:text-white placeholder:text-gray-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:bg-gray-900 transition-colors"
                                    placeholder="Guardian name">
                                <p id="guardian_nameError" class="mt-1 text-xs text-red-500 hidden"></p>
                            </div>
                            <div>
                                <label for="guardian_phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                    Guardian Phone
                                </label>
                                <input type="text" id="guardian_phone" name="guardian_phone"
                                    class="w-full h-11 rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent px-4 text-sm text-gray-800 dark:text-white placeholder:text-gray-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:bg-gray-900 transition-colors"
                                    placeholder="Phone number">
                                <p id="guardian_phoneError" class="mt-1 text-xs text-red-500 hidden"></p>
                            </div>
                        </div>
                        <div>
                            ...
                            <p id="addressError" class="mt-1 text-xs text-red-500 hidden"></p>
                        </div>
                    </div>
