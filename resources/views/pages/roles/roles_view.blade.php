                                ...
                                <tr id="emptyRow">
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400 font-medium">No roles found</p>
                                            <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Click "Add Role" to create your first role</p>
                                        </div>
                                    </td>
                                </tr>
                            @endif
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            // Open modal
            function openModal(title = 'Add Role') {
