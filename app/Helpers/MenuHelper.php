...
class MenuHelper
{
    ...
    public static function getSettingsNavItems(): array
    {
        ...
        if ($user->can('user-list')) {
            $items[] = ['icon' => 'users', 'name' => 'Users', 'path' => '/users'];
        }
        if ($user->can('role-list')) {
            $items[] = ['icon' => 'roles', 'name' => 'Roles', 'path' => '/roles'];
        }
        if ($user->can('permission-list')) {
            $items[] = ['icon' => 'permissions', 'name' => 'Permissions', 'path' => '/permissions'];
        }
